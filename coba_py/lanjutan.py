...
if __name__ == '__main__':
    ...
    print("Website telah dibuat dengan fitur:")
    ...
    print("\nFitur yang tersedia:")
    print("- Input fungsi matematika (x**2, sin(x), cos(x), exp(x), dll)")
    print("- Pengaturan batas integral dan jumlah subinterval")
    print("- Perbandingan dengan nilai analitik (jika tersedia)")
    print("- Visualisasi grafik dengan overlay metode numerik")
    print("- Responsive design untuk mobile dan desktop")
